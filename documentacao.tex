...
A escassez de uma solução visual, juntamente com as informações desorganizadas causam impactos extremamente negativos nas pessoas envolvidas, além disso, é bem possível que os impactos citados sejam percebidos no setor financeiro, entre outros. Segue exemplos de impactos:
\begin{itemize}
